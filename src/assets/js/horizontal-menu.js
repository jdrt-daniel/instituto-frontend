  ...
  (function () {
    ...
    jQuery(function () {
      ...
      jQuery(".horizontalMenu > .horizontalMenu-list > li > ul > li > ul > li")
        .has(".sub-menu")
        .prepend(
          '<span class="horizontalMenu-click03"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span>'
        );
      jQuery(
        ".horizontalMenu > .horizontalMenu-list > li > ul > li > ul > li > ul > li"
      )
        .has(".sub-menu")
        .prepend(
          '<span class="horizontalMenu-click04"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span>'
        );
      jQuery(".horizontalMenu-click02").click(function () {
        jQuery(
          ".horizontalMenu > .horizontalMenu-list > li > .sub-menu .sub-menu"
        )
          .not(
            jQuery(this).siblings(
              ".horizontalMenu > .horizontalMenu-list > li > .sub-menu .sub-menu"
      ...
      jQuery(".horizontalMenu-click03").click(function () {
        jQuery(
          ".horizontalMenu > .horizontalMenu-list > li > .sub-menu .sub-menu .sub-menu"
        )
          .not(
            jQuery(this).siblings(
              ".horizontalMenu > .horizontalMenu-list > li > .sub-menu .sub-menu .sub-menu"
      ...
      jQuery(".horizontalMenu-click04").click(function () {
        jQuery(
          ".horizontalMenu > .horizontalMenu-list > li > .sub-menu .sub-menu .sub-menu .sub-menu"
        )
          .not(
            jQuery(this).siblings(
              ".horizontalMenu > .horizontalMenu-list > li > .sub-menu .sub-menu .sub-menu .sub-menu"
